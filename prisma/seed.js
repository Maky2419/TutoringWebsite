...
async function main() {
  ...
  const tutorUser = await prisma.user.upsert({
    where: { email: "ahsankalam04@gmail.com" },
    update: {
      name: "Muhammad Ahsan",
      password: hashedPassword,
      role: UserRole.TUTOR,
  ...
  const ahsanTutorId = tutorIdByEmail.get("ahsankalam04@gmail.com");

  if (ahsanTutorId) {
    await prisma.studentTutorAssignment.upsert({
      where: {
        tutorId_studentId: {
          tutorId: ahsanTutorId,
    ...
    console.log("Seeded tutor-student assignment.");
  }
      ...
      reviewsToCreate.push(
        {
          rating: 5,
          comment:
            "It is our pleasure to write this letter to recommend Ms. Amber as an excellent math teacher. Ms.Amber uses different teaching techniques that encourages our children to ask queries, clarifies any doubts which helps them to develop conceptual understanding. Since our engagement with Ms. Amber, we have noticed that our kids’ interest in math has increased which is also reflected in their grades at class. We strongly recommend Ms. Amber as a very professional, dedicated math teacher.",
        ...
        },
        {
          rating: 5,
          comment:
            "We had Mrs.Amber as my daughter’s math tutor since 3rd grade, and with time, over the last 3 years, I have seen my daughter developing interest and confidence in Math. Amber was a catalyst in my daughter’s life who changed the perspective for her that Math does not resonate fear and anxiety but Math is interesting, logical and fun.",
        ...
        },
        {
          rating: 5,
          comment:
            "Amber has worked as a math tutor for our daughter, Kimberly Ocean, for several years, both during middle school and high school. Kimberly Ocean was at that time a student at ABA Muscat, Oman (IB curriculum). Amber has been an invaluable help to get our daughter through school with a good grade. Kimberly Ocean had difficulty understanding the schools teaching method and was really struggling. Amber had the ability to find a way to teach her that made sense to her and at the same time boost her self confidence to succeed. We will highly recommend Amber.",
        ...
        },
        {
          rating: 4,
          comment:
            "Hi Amber, I got my Criterion A and C marks back from before the winter break — A: 8 and C: 7. This honestly would not have been possible without your help. Thank you so much!",
          student: "Hamza",
          tutorId: ambreenId,
          createdAt: new Date("2026-01-18"),
        },
        {
          rating: 5,
          comment:
            "Hi Amber, I just wanted to send you a message. Thank you very much, Alya was so happy and relaxed, she was excited because her answers were correct 😊 you gave her this feeling that she can do it. She’ll be more than happy to take more classes with you 🌹",
          student: "Alya Parent",
          tutorId: ambreenId,
          createdAt: new Date("2026-01-18"),
        },
  ...
  console.log("Admin login: admin@kcubed.ca / password123");
  console.log("Tutor login: ahsankalam04@gmail.com / password123");
  console.log("Student login: student@kcubed.ca / password123");
}

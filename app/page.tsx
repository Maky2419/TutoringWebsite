          ...
          <div className="py-20 md:py-28">
            <div className="mx-auto max-w-3xl text-center">
              <p className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-xs font-medium text-white/80">
                ...
                K-Cubed Tutoring • Book tutoring without the back-and-forth
              </p>
            ...
            <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
              <div className="glass p-8">
                ...
                <p className="mt-3 text-sm text-white/70">
                  K-Cubed Tutoring is designed around clarity: students know what they’re booking, tutors know what to expect,

            ...
            <div className="rounded-3xl md:rounded-[36px] border border-blue-100 bg-white p-5 sm:p-7 md:p-8 shadow-xl md:p-12">
              <div className="mx-auto mb-8 max-w-3xl text-center">
                ...
                <p className="mt-4 text-slate-600">
                  Clear, focused, one-on-one support that helps students learn
                  at their own pace.
                </p>
              </div>
          ...
          <section className="py-8">
            <div className="rounded-3xl md:rounded-[36px] border border-blue-100 bg-white p-5 sm:p-7 md:p-8 shadow-xl md:p-12">
              ...
              {tutors.length > 0 ? (
                <div className="grid gap-5 sm:p-7 md:p-8 md:grid-cols-2 lg:grid-cols-3">
                  {tutors.map((tutor) => {
                    ...
                    return (
                      <div
                        key={tutor.id}
                        className="rounded-[28px] border border-blue-100 bg-blue-50 p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-md"
                      >
                ...
                <div className="rounded-3xl border border-blue-100 bg-blue-50 p-10 text-center shadow-sm">
